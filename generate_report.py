...
def main():
    ...
    story = [
        ...
        p('8. 결론과 한계', 'HeadK'),
        p('이번 실험은 전국 전력수요와 서울 단일 날씨가 아니라 7개 주요 지역의 ASOS 날씨를 함께 사용했습니다. 모든 모델의 시험 조건은 동일한 one-step-ahead 방식으로 맞췄고, 예측 구간은 검증 잔차만 사용해 데이터 누출을 피했습니다. 현재 구간은 잔차 기반 근사이므로 엄밀한 확률 구간은 아닙니다. 향후 quantile loss, conformal prediction, Monte Carlo dropout, ARIMA 차수 탐색을 적용할 수 있습니다.'),
